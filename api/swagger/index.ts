...
export class NotificationService {
   ...
   *
   */
  static notificationControllerPushNotification(
    options: IRequestOptions = {}
  ): Promise<any> {
    return new Promise((resolve, reject) => {
   ...
   *
   */
  static notificationControllerPushNotificationByUserId(
    options: IRequestOptions = {}
  ): Promise<any> {
    return new Promise((resolve, reject) => {
   ...
   *
   */
  static notificationControllerGetPublickey(
    options: IRequestOptions = {}
  ): Promise<any> {
    return new Promise((resolve, reject) => {
   ...
   *
   */
  static notificationControllerGetIsPush(
    options: IRequestOptions = {}
  ): Promise<any> {
    return new Promise((resolve, reject) => {
   ...
   *
   */
  static notificationControllerGetShopIsPush(
    options: IRequestOptions = {}
  ): Promise<any> {
    return new Promise((resolve, reject) => {
...
export class ShopUserService {
   ...
   * 유저 삭제
   */
  static shopUserControllerUseDelete(
    options: IRequestOptions = {}
  ): Promise<any> {
    return new Promise((resolve, reject) => {
      let url = basePath + "/shop-user";
   ...
   * 내정보 얻기
   */
  static shopUserControllerMyInfo(
    options: IRequestOptions = {}
  ): Promise<LoginShopUserOutPut> {
    return new Promise((resolve, reject) => {
   ...
   * 패스워드 확인
   */
  static shopUserControllerPasswordConfirm(
    options: IRequestOptions = {}
  ): Promise<CoreOutPut> {
    return new Promise((resolve, reject) => {
   ...
   * 회사 정보 삭제
   */
  static shopUserControllerDeleteCompany(
    options: IRequestOptions = {}
  ): Promise<UpdateCompanyOutPutDto> {
    return new Promise((resolve, reject) => {
      let url = basePath + "/shop-user/company";
...
export class ShopitemService {
  ...
  static shopItemControllerSearchItems(
    ...
    return new Promise((resolve, reject) => {
      ...
      configs.params = {
        title: params["title"],
        take: params["take"],
        createTimeOrder: params["createTimeOrder"],
      };
   ...
   * 등록한 아이템들 얻기
   */
  static shopItemControllerGetSellItems(
    options: IRequestOptions = {}
  ): Promise<SellitemsOutPutDto> {
    return new Promise((resolve, reject) => {
   ...
   * 장바구니 아이템 얻기
   */
  static shopItemControllerGetBasketItems(
    options: IRequestOptions = {}
  ): Promise<GetBasketItemsOutPutDto> {
    return new Promise((resolve, reject) => {
   ...
   * 주문내역
   */
  static shopItemControllerGetIreceipt(
    options: IRequestOptions = {}
  ): Promise<GetIreceiptOutPutDto> {
    return new Promise((resolve, reject) => {
      let url = basePath + "/shop-item/ireceipt";
   ...
   * 판매한 아이템 목록
   */
  static shopItemControllerGetSoldItem(
    options: IRequestOptions = {}
  ): Promise<GetSoldItemsOutPutDto> {
    return new Promise((resolve, reject) => {
   ...
   * 판매중인 아이템 목록
   */
  static shopItemControllerGetSalesItems(
    options: IRequestOptions = {}
  ): Promise<GetSalseItemsOutPutDto> {
    return new Promise((resolve, reject) => {
   ...
   * 아이템 정보 얻기
   */
  static shopItemControllerGetItemById(
    options: IRequestOptions = {}
  ): Promise<GetItemInfoOutPutDto> {
    return new Promise((resolve, reject) => {
      let url = basePath + "/shop-item/{id}";
   ...
   * 아이템 삭제
   */
  static shopItemControllerDeleteItem(
    options: IRequestOptions = {}
  ): Promise<CoreOutPut> {
    return new Promise((resolve, reject) => {
      let url = basePath + "/shop-item/{id}";
